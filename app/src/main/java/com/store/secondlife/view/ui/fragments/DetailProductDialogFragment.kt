 ...
 */
class DetailProductDialogFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_detail_product_dialog, container, false)
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
                DetailProductDialogFragment().apply {
